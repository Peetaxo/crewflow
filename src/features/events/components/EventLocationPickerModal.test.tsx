...
describe('EventLocationPickerModal', () => {
  ...
  it('keeps the dialog usable when WebGL map initialization is unavailable', () => {
    mapMock.mockImplementationOnce(function MockUnavailableMap() {
    ...
    expect(screen.getByText('Mapu se na tomto zařízení nepodařilo zobrazit.')).toBeInTheDocument();
    expect(screen.getByRole('button', { name: 'Potvrdit polohu' })).toBeDisabled();
