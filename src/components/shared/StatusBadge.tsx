...
const StatusBadge = ({ status, label }: { status: string; label?: string }) => {
  const statusMap: Record<string, [string, string]> = {
    ...
    pending_ch: ['bg-amber-50 text-amber-700', 'Ceka CH'],
    pending_coo: ['bg-blue-50 text-blue-700', 'Ceka COO'],
    approved: ['bg-emerald-50 text-emerald-700', 'Schvaleno'],
    invoiced: ['bg-teal-50 text-teal-700', 'Fakturovano'],
    paid: ['bg-teal-50 text-teal-700', 'Zaplaceno'],
    rejected: ['bg-red-50 text-red-700', 'Zamitnuto'],
    sent: ['bg-blue-50 text-blue-700', 'Odeslano'],
    disputed: ['bg-red-50 text-red-700', 'Rozporovano'],
    submitted: ['bg-amber-50 text-amber-700', 'Ceka na schvaleni'],
    attached: ['bg-cyan-50 text-cyan-700', 'Ve fakture'],
    reimbursed: ['bg-teal-50 text-teal-700', 'Proplaceno'],
    upcoming: ['bg-blue-50 text-blue-700', 'Nadchazejici'],
    full: ['bg-emerald-50 text-emerald-700', 'Obsazeno'],
    planning: ['bg-gray-100 text-gray-600', 'Planovani'],
    new: ['bg-blue-50 text-blue-700', 'Novy'],
    interview_scheduled: ['bg-amber-50 text-amber-700', 'Pohovor'],
    decision: ['bg-indigo-50 text-indigo-700', 'Rozhodnuti'],
    accepted: ['bg-emerald-50 text-emerald-700', 'Prijat'],
    ...
    past: ['bg-gray-100 text-gray-500', 'Uplynule'],
  };
