-- Draft only.
-- Nespoustet bez odsouhlaseni.

begin;

-- 1. Profiles: oddelit jednoduchy tag spolehlivosti od ciselneho hodnoceni.
...
comment on column public.profiles.reliable is
  'Jednoduchy interní tag: je tento clen crew povazovan za spolehliveho?';
...
-- 2. Events: JSON defaulty sladit s frontendem.
